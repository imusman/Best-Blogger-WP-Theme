 ...
 */
function best_blogger_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'best_blogger_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'best_blogger_customize_partial_blogdescription',
		) );
	}
}
add_action( 'customize_register', 'best_blogger_customize_register' );
 ...
 * @return void
 */
function best_blogger_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function best_blogger_customize_partial_blogdescription() {
 ...
 */
function best_blogger_customize_preview_js() {
	wp_enqueue_script( 'best_blogger_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'best_blogger_customize_preview_js' );
...
if ( ! function_exists( 'best_blogger_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see best_blogger_custom_header_setup().
 */
function best_blogger_header_style() {
